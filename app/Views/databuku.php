<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                <a href="<?= base_url('home/TambahBuku') ?>">
                            ...
                            <table id="example" class="display" style="min-width: 845px; color: black;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tdcoy">
                                        ...
                                        <td>
                                            <a href="<?= base_url('home/EditBuku/' . $record->id_buku) ?>">
                                                <button class="btn btn-dark">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                            </a>
                                            <a href="<?= base_url('home/SDBuku/' . $record->id_buku) ?>" onclick="return confirm('Yakin ingin menghapus Buku ini?')">
